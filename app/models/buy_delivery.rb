class BuyDelivery
  ...
  def save
    ...
    Delivery.create(post_code: postal_code, prefecture: prefecture, municipality: city, address: addresses, building_name: building, telephone_number: phone_number, buy_id: buy.id)
  end
end